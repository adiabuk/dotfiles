...
#c.InteractiveShell.banner1 = "Python 3.5.4 (default, Feb  6 2018, 16:09:52) \nType 'copyright', 'credits' or 'license' for more information\nIPython 6.2.1 -- An enhanced Interactive Python. Type '?' for help.\n"
...
#         highlighting:
#  emacs, algol, vim, lovelace, native, abap, xcode, tango, bw, monokai, vs, trac, rrt, autumn, igor, default, perldoc, algol_nu, rainbow_dash, arduino, murphy, manni, colorful, fruity, pastie, paraiso-dark, friendly, paraiso-light, borland
